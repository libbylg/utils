...
extern int   test_cat_file(int argc, char* argv[])
{
    const char* file = "/Users/baidu/baidu/svn/navi-qa-dev/tool/"
        "BehaviorAnalysis/BehaviorAnalysis/behavior-history/behavior_parser.cpp";
